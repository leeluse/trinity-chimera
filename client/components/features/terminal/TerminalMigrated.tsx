...
export default function TerminalMigrated() {
  ...
  const hunterAlert = useTerminalStore((s) => s.hunterAlert);
  const setHunterAlert = useTerminalStore((s) => s.setHunterAlert);
  const [visibleAlert, setVisibleAlert] = useState<typeof hunterAlert>(null);
