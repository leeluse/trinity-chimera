    ...
    <div className="relative overflow-hidden h-[450px] shrink-0 w-full bg-[#060912]/40 backdrop-blur-sm border border-white/[0.05] rounded-xl">
      ...
      {loading && (
        <div className="absolute inset-0 bg-black/80 backdrop-blur-sm z-50 flex flex-col items-center justify-center gap-4">
          <div className="w-8 h-8 rounded-full border-2 border-primary/30 border-l-primary animate-spin" />
          <p className="text-primary font-semibold text-[10px] tracking-[0.2em] uppercase">Simulating Markets...</p>
        </div>
      )}
    </div>
  );
